...
Key Features: User authentication with role-based access Food donation posting and interactive request workflow
Complete donation and request history tracking

A full-stack app connecting 
**restaurants** with surplus food to **NGOs / receivers**,
